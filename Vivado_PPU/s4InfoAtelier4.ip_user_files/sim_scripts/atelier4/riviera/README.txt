...
#
# Generated by export_simulation on Thu Mar 16 14:55:25 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './atelier4.sh' script.

./atelier4.sh -reset_run
...
./atelier4.sh -noclean_files

For more information on the script, please type './atelier4.sh -help'.
