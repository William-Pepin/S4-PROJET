...
HD_PWD='C:/Vivado/S4-PROJET/Vivado - PPU/s4InfoAtelier4.runs/atelier4_mycolorRegister_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atelier4_mycolorRegister_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atelier4_mycolorRegister_0_0.tcl
