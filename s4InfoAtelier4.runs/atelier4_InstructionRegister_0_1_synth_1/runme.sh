...
HD_PWD='C:/Users/wpepi/projet/s4InfoAtelier4.runs/atelier4_InstructionRegister_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atelier4_InstructionRegister_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atelier4_InstructionRegister_0_1.tcl
