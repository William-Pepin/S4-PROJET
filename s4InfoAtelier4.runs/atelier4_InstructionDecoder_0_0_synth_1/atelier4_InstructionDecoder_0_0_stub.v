...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(i_opcode, i_instruction_data, o_colorData, 
  o_colorSel, o_colorWriteEN, o_tileId, o_paletteId, o_x, o_y, o_bufferWriteEn, o_bcgWriteEn)
/* synthesis syn_black_box black_box_pad_pin="i_opcode[3:0],i_instruction_data[27:0],o_colorData[23:0],o_colorSel[3:0],o_colorWriteEN,o_tileId[7:0],o_paletteId[3:0],o_x[9:0],o_y[9:0],o_bufferWriteEn,o_bcgWriteEn" */;
  input [3:0]i_opcode;
