...
HD_PWD='C:/Users/Raphael/Documents/Sherb/S4/PROJET/S4-PROJET/joystick/joystick.runs/joystick_pmod_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log joystick_pmod_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source joystick_pmod_xbar_0.tcl
