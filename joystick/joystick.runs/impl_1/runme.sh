...
HD_PWD='C:/Users/Raphael/Documents/Sherb/S4/PROJET/S4-PROJET/joystick/joystick.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log joystick_pmod_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source joystick_pmod_wrapper.tcl -notrace
